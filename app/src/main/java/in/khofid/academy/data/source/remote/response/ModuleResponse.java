package in.khofid.academy.data.source.remote.response;
...
public class ModuleResponse implements Parcelable {
    ...
    public static final Parcelable.Creator<ModuleResponse> CREATOR = new Parcelable.Creator<ModuleResponse>() {
        @Override
